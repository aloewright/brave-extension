...
const ICONS: Record<LeoIconName, ReactNode> = {
  ...
  download: (
    <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M12 3a.8.8 0 0 1 .8.8v9.27l3.04-3.04a.8.8 0 1 1 1.13 1.13l-4.4 4.41a.8.8 0 0 1-1.14 0l-4.4-4.4a.8.8 0 0 1 1.13-1.14l3.04 3.04V3.8A.8.8 0 0 1 12 3M4.8 14.4a.8.8 0 0 1 .8.8v2.4a1.2 1.2 0 0 0 1.2 1.2h10.4a1.2 1.2 0 0 0 1.2-1.2v-2.4a.8.8 0 0 1 1.6 0v2.4a2.8 2.8 0 0 1-2.8 2.8H6.8A2.8 2.8 0 0 1 4 17.6v-2.4a.8.8 0 0 1 .8-.8" />
  ),
  "eye-on": (
  ...
  "list-checks": (
    <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M8.2 5.4a.8.8 0 0 1 .8-.8h10a.8.8 0 0 1 0 1.6H9a.8.8 0 0 1-.8-.8M4.53 4.47a.75.75 0 0 0-1.06 1.06l1.2 1.2a.75.75 0 0 0 1.06 0l2.2-2.2a.75.75 0 0 0-1.06-1.06L5.2 5.14zm3.67 7.53a.8.8 0 0 1 .8-.8h10a.8.8 0 0 1 0 1.6H9a.8.8 0 0 1-.8-.8m-3.67-.93a.75.75 0 0 0-1.06 1.06l1.2 1.2a.75.75 0 0 0 1.06 0l2.2-2.2a.75.75 0 1 0-1.06-1.06L5.2 11.74zM8.2 18.6a.8.8 0 0 1 .8-.8h10a.8.8 0 0 1 0 1.6H9a.8.8 0 0 1-.8-.8m-3.67-.93a.75.75 0 0 0-1.06 1.06l1.2 1.2a.75.75 0 0 0 1.06 0l2.2-2.2a.75.75 0 1 0-1.06-1.06L5.2 18.34z" />
  ),
  lock: (
    <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M8 9V7.5a4 4 0 0 1 8 0V9h1.2A2.8 2.8 0 0 1 20 11.8v6.4a2.8 2.8 0 0 1-2.8 2.8H6.8A2.8 2.8 0 0 1 4 18.2v-6.4A2.8 2.8 0 0 1 6.8 9zm1.6 0h4.8V7.5a2.4 2.4 0 0 0-4.8 0zM6.8 10.6a1.2 1.2 0 0 0-1.2 1.2v6.4a1.2 1.2 0 0 0 1.2 1.2h10.4a1.2 1.2 0 0 0 1.2-1.2v-6.4a1.2 1.2 0 0 0-1.2-1.2zm6 4.04a1.4 1.4 0 0 1-.8 2.55 1.4 1.4 0 0 1-.8-2.55V13.8a.8.8 0 0 1 1.6 0z" />
  ),
  "paint-brush": (
    <>
