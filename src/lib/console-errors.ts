...
const EXTENSION_SOURCE_RE =
  /^chrome-extension:\/\/[^/]+\/(?:error-capture|page-errors|page-console-bridge|scanner|picker|inspector)\.[\w-]+\.js/i
...
export function shouldCaptureConsoleEntry(
  entry: Pick<ConsoleError, "message" | "source">
): boolean {
