...
// GUI-launched apps (Brave/Chrome) don't inherit the user's shell PATH. Keep
// the machine-specific Node and checkout paths in ~/.config instead of
// rewriting a tracked file inside the repository.
const { path: hostPath } = writeNativeHostLauncher({
  nodeBin: process.execPath,
  hostScript
})
console.log(`✓ Wrote native-host launcher: ${hostPath}`)
